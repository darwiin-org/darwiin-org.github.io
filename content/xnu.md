...
After Apple acquired NeXT, the kernel was updated with code derived from OSF MK 7.3 from OSF,[4] and the FreeBSD project, and the DriverKit was replaced with new API on a restricted subset of C++ (based on Embedded C++) named IOKit.
